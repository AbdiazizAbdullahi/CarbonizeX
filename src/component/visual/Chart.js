...
const Chart = ({electric, fuel, shipping})=> {
    ...
    return(
        <div>
            <h1>Charts(Electricity-purple color; Fuel-Black color; Shipping-pink color)</h1>
            <PieChart width={730} height={400}>
                <Pie data={electric} dataKey="carbon_kg" nameKey="electricity_value" cx="20%" cy="20%" innerRadius={30} outerRadius={60} fill="#8884d8" label/>
